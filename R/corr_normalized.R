#' @title correlation-test with data normalized by CN.
#'
#' @description This function conduct differential abundant test by correlation-test with data normalized by CN.
#'
...
corr.normalized = function(physeq = NULL, count_table = NULL, tax_level = NULL, meta = NULL, main_var, type = "pearson",
                        method = "BH", alpha = 0.05, eta = 0, lib_cut = 0, bootstap_num = 3){
